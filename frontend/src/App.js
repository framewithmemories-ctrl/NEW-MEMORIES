...
const SEOHead = () => (
  <Helmet>
    ...
    <meta property="og:url" content="https://memories-shop.preview.emergentagent.com" />
    <meta name="twitter:card" content="summary_large_image" />
    <link rel="canonical" href="https://memories-shop.preview.emergentagent.com" />
    ...
    <script type="application/ld+json">
      {JSON.stringify({
        ...
        "url": "https://memories-shop.preview.emergentagent.com",
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-green-200 max-w-2xl mx-auto">
            ...
            <div className="space-x-4">
              ...
              <Button 
                ...
                onClick={() => window.open('https://search.google.com/local/writereview?placeid=ChIJX8W6BJ8VqzsRQH_MrOqcD9A', '_blank')}
              >
